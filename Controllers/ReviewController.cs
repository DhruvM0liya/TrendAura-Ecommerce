...
namespace trendaura.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public async Task<IActionResult> Add(ProductReviewsViewModel model)
        {
            ...
            // FIX 1: 'ProductId' ki jagah 'AccessoryId' use karein
            // FIX 2: 'Reviews' DbSet ki jagah check karein agar aapke context mein 'AccessoryReviews' hai
            ...
            // FIX 3: 'Review' ki jagah 'AccessoryReview' object create karein
